...
class StudentProfile(models.Model):
    ...
    hs_status = models.CharField(max_length=50, help_text="e.g., Freshman, Senior, Graduated")
    college_status = models.CharField(max_length=50, help_text="e.g., Prospective, Applied, Enrolled")
...
class MentorStudentAssignment(models.Model):
    mentor = models.ForeignKey(MentorProfile, on_delete=models.CASCADE, related_name='assignments')
    student = models.ForeignKey(StudentProfile, on_delete=models.CASCADE, related_name='assigned_mentors')
